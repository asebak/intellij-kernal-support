...
import com.atsebak.kernel.project.builder.CppSdkType;
...
public class ChooseCppSdkStep extends ModuleWizardStep {
    ...
    public ChooseCppSdkStep(WizardContext wizardContext, CppModuleBuilder cppModuleBuilder) {
        this.myModuleBuider = cppModuleBuilder;
        ...
        mySdkCombo.addBrowseFolderListener(
                ...
                new FileChooserDescriptor(true, true, false, false, false, false) {
                    public boolean isFileSelectable(VirtualFile virtualFile) {
                        return super.isFileSelectable(virtualFile) && (CppSupportSettings.isGccPath(virtualFile));
                    }
                },
